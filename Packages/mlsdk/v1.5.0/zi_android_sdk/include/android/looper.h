 ...
 * there is not one.
 */
ZI_API ALooper* ZI_CALL ALooper_forThread();
 ...
 */
ZI_API ALooper* ALooper_prepare(int opts);
 ...
 */
ZI_API int ZI_CALL ALooper_pollOnce(int timeoutMillis, int* outFd, int* outEvents, void** outData);
 ...
 */
ZI_API int ZI_CALL ALooper_pollAll(int timeoutMillis, int* outFd, int* outEvents, void** outData);
 ...
 */
ZI_API int ZI_CALL ALooper_addFd(ALooper* looper, int fd, int ident, int events, ALooper_callbackFunc callback, void* data);
 ...
 * This method may block briefly if it needs to wake the poll.
 */
ZI_API int ZI_CALL ALooper_removeFd(ALooper* looper, int fd);
