...
namespace GLTFast
{
    ...
    public abstract class GltfImportBase : IGltfReadable, IGltfBuffers, IDisposable
    {
            ...
            )
        {
	        ...
	        {
		        localPath = localPath.Insert(0, "file://");
	        }
	        else if (localPath.StartsWith("/jar:"))
	        {
		        localPath = localPath.Remove(0, 11);
		        localPath = localPath.Insert(0, "jar:file://");
	        }
	        ...
	        using (UnityWebRequest www = UnityWebRequest.Get(localPath))
	        {
		        ...
		        while (!www.isDone)
		        {
			        ...
			        {
				        throw new Exception($"Connection Error while reading File '{localPath}'");
			        }
		        }
		        if (www.result == UnityWebRequest.Result.ConnectionError)
		        {
		        ...
		        WwwData = www.downloadHandler.data;
	        }
#endif
	        ...
	        await using
#endif
		        var fs = new MemoryStream(WwwData);
#else
#if UNITY_2021_3_OR_NEWER && NET_STANDARD_2_1
            await using
#endif
