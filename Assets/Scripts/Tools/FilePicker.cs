...
public static class FilePicker
{
	public class FilePickerResult
	{
		...
		public bool HavePath
		{
			get
			{
				return this.IsCanceled == false && this.HaveError == false && string.IsNullOrEmpty(this.Path) == false;
			}
		}
	...
	public static void ChooseFile(Action<FilePickerResult> fileSelected, WellKnownLocation location = WellKnownLocation.Unspecified, PickerView pickerView = PickerView.Thumbnail, params string[] filters)
	{
		FilePickerResult result = new FilePickerResult();
