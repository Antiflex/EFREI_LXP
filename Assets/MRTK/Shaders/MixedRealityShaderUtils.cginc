...
#if defined(_CLIPPING_PLANE) || defined(_CLIPPING_PLANE2)
...
#if defined(_CLIPPING_SPHERE) || defined(_CLIPPING_SPHERE2)
...
#if defined(_CLIPPING_BOX) || defined(_CLIPPING_BOX2)
